...
class ObjectsExtTest {
    ...
    private fun Track.copy(md5Image: String? = this.md5Image): Track = Track(
        id = id,
        ...
        isExplicitLyrics = isExplicitLyrics,
    ...
    private fun Playlist.copy(md5Image: String? = this.md5Image): Playlist = Playlist(
        id = id,
        title = title,
